                     ...
                     <ul class="navbar-nav mr-auto">
                      <div class="d-flex ">
                        ...
                        <li class="nav-link mr-5 hover">
                                <a href="" class="nav-link text-dark">CEK KEGIATAN</a>
                            </li>
                        <li class="nav-link mr-5 hover">
                                <a href="{{route('dashboard.index')}}" class="nav-link text-dark">DASHBOARD</a>
                            </li>
                            <li class="nav-link mr-5 hover">
                                <a href="{{route('data-rakyat.index')}}" class="nav-link text-dark">DATA MASYARAKYAT</a>
                            </li>
                            <li class="nav-link mr-5 hover">
                                <a href="{{route('kegiatan.index')}}" class="nav-link text-dark">MANAGE KEGIATAN</a>
                            </li>
                            <li class="nav-link mr-5 hover">
                                <a href="{{route('verifikasi.index')}}" class="nav-link text-dark">VERIFIKASI</a>
                            </li>
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                           <a class ="dropdown-item" href="{{route('laporan.data')}}" class="dropdown-item">Data Masyarakat</a>
                            <a class ="dropdown-item" href="{{route('laporan.activity')}}" class="dropdown-item">Tabel Kegiatan</a>
                            <a class ="dropdown-item" href="{{route('laporan.verified')}}" class="dropdown-item">Terverifikasi</a>
                            <a class ="dropdown-item" href="{{route('laporan.dashboard')}}" class="dropdown-item">Dashboard</a>
                            </div>
                        </li>
                    </ul>
                    </div>
